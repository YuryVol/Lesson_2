...
# }
goods = []
while input("Хотите добавить продукт? Введите да или нет: ") == 'да':
    number = int(input("Введите номер продукта: "))
    features = {}
    while input("Хотите добавить зарактеристики продукта? Введите да или нет: ") == 'да':
        feature_key = input("Введите характеристики: ")
